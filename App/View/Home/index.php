                ...
                <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="https://bossearn.com/?logout=true">Logout</a>
                            </li>
                        </ul>
                        ...
                        <div class="page-wrapper">
                            <div class="blog-custom-build">
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <a href="marketing-single.html" title="">
                                            <img src="<?php echo $assets; ?>upload/market_blog_01.jpg" alt="" class="img-fluid">
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <a href="marketing-single.html" title="">
                                            <img src="<?php echo $assets; ?>upload/market_blog_02.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div>
                                            <!-- end hover -->
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <a href="marketing-single.html" title="">
                                            <img src="<?php echo $assets; ?>upload/market_blog_03.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div>
                                            <!-- end hover -->
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <a href="marketing-single.html" title="">
                                            <img src="<?php echo $assets; ?>upload/market_blog_04.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div>
                                            <!-- end hover -->
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <a href="marketing-single.html" title="">
                                            <img src="<?php echo $assets; ?>upload/market_blog_05.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div>
                                            <!-- end hover -->
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <a href="marketing-single.html" title="">
                                            <img src="<?php echo $assets; ?>upload/market_blog_06.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div>
                                            <!-- end hover -->
                        ...
                        <div class="sidebar">
                                    ...
                                    <div class="list-group">
                                        <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                            <div class="w-100 justify-content-between">
                                                <img src="<?php echo $assets; ?>upload/small_07.jpg" alt="" class="img-fluid float-left">
                                        ...
                                        <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                            <div class="w-100 justify-content-between">
                                                <img src="<?php echo $assets; ?>upload/small_08.jpg" alt="" class="img-fluid float-left">
                                        ...
                                        <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                            <div class="w-100 last-item justify-content-between">
                                                <img src="<?php echo $assets; ?>upload/small_09.jpg" alt="" class="img-fluid float-left">
                            ...
                            <div id="" class="widget">
                                ...
                                <div class="banner-spot clearfix">
                                    <div class="banner-img">
                                        <img src="<?php echo $assets; ?>upload/banner_03.jpg" alt="" class="img-fluid">
                                    </div><!-- end banner-img -->
                                </div><!-- end banner -->
                            </div><!-- end widget -->
                            ...
                            <div class="widget">
                                ...
                                <div class="instagram-wrapper clearfix">
                                    <a class="" href="#"><img src="<?php echo $assets; ?>upload/small_09.jpg" alt="" class="img-fluid"></a>
                                    <a href="#"><img src="<?php echo $assets; ?>upload/small_01.jpg" alt="" class="img-fluid"></a>
                                    <a href="#"><img src="<?php echo $assets; ?>upload/small_02.jpg" alt="" class="img-fluid"></a>
                                    <a href="#"><img src="<?php echo $assets; ?>upload/small_03.jpg" alt="" class="img-fluid"></a>
                                    <a href="#"><img src="<?php echo $assets; ?>upload/small_04.jpg" alt="" class="img-fluid"></a>
                                    <a href="#"><img src="<?php echo $assets; ?>upload/small_05.jpg" alt="" class="img-fluid"></a>
                                    <a href="#"><img src="<?php echo $assets; ?>upload/small_06.jpg" alt="" class="img-fluid"></a>
                                    <a href="#"><img src="<?php echo $assets; ?>upload/small_07.jpg" alt="" class="img-fluid"></a>
                                    <a href="#"><img src="<?php echo $assets; ?>upload/small_08.jpg" alt="" class="img-fluid"></a>
