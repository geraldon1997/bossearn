                            ...
                            <div class="blog-custom-build">
                                ...
                                <div class="blog-box wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
                                    <div class="post-media">
                                        <a href="http://bossearn.com/news.php?news=<?php echo $post['id'] ?>" title="">
                                    ...
                                    <div class="blog-meta big-meta text-center">
                                        ...
                                        <a href="http://bossearn.com/news.php?news=<?php echo $post['id'] ?>" class="btn" post-id="<?php echo $post['id'] ?>" id="read">Read more</a>
                                        <hr class="invis">
